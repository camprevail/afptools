...
The pattern file afp format is based on dragonminded's bemaniutils/afputils code. I've also added some documentation on
the afp format in [AFP_FORMAT.MD](AFP_FORMAT.MD). 
